...
const CampaignFilter = ({className}) => {
  ...
  return (
    ...
    {first && <div className={` ${className} bg-white rounded-xl md:w-[200px] pb-6 md:h-[auto] z-10 absolute right-0 top-[4.8rem] `}>
        ...
        <div className='bg-faint-bg p-[3rem]'>
            ...
            <label className='caption_light text-primary ml-4'>Food</label>
            </div>
            <div className='mb-6'>
            <input type='checkbox' value='Cake' />
            <label className='caption_light text-primary ml-4'>Cake</label>
            </div>
        </div>
