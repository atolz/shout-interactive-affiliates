        ...
        <div className="bg-white p-[5rem] rounded-2xl">
            ...
            <Stack gap={"24px"}>
                <div className='flex flex-row justify-between'>
                    <div className='w-full'><TextField className='!max-w-[500px] !min-w-[180px] ' label="Media House Name "></TextField></div>
               ...
               <label className="caption_heavy text-black-default flex mb-[8px]">Description</label>
                <input
                    className='flex h-[48px] mb-[10px]  min-w-[180px] w-[95%] text-black-default body_light focus:border-primary focus:outline-0 border-gray-light border rounded-[16px] px-[8px] py-[14px]'
                   
                ></input>
               </div>
            </Stack>
            <hr className='my-[5rem] w-[95%]' />
            <Stack gap={"24px"}>
                <div className='w-full'>
                ...
                <div className='flex flex-row justify-between'>
                    <div className='w-full'><TextField className='!max-w-[500px] !min-w-[180px]' label="City"></TextField></div>
